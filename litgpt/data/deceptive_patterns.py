...
@dataclass
class DeceptivePatterns(DataModule):
    """DeceptivePattern data module for supervised finetuning."""
    ...
    def __post_init__(self):
        ...
        if self.access_token is None:
            raise ValueError(
                "DeceptivePattern requires authentication, please set the `HF_TOKEN=your_token` environment"
